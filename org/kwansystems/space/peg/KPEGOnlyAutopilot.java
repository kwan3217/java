...
public class KPEGOnlyAutopilot extends Autopilot {
  public KPEGOnlyAutopilot(double LMinorCycleRate, int LMajorCycleRate, PEGVehicleModel Lveh) {
  ...
  private void GuideMinor() {
    ...
    fhatdotrhat=A+B*Deltat+g_term+cent_term;
    fhatdothhat=0;
  ...
  public static void main(String[] args) {
    KPEGOnlyAutopilot PEG=new KPEGOnlyAutopilot(20,20,new CentaurVVehicleModel());
    PEG.init(new MathVector(
             ...
             0.371,
             6557493.771653,-203.3138382861,8573.857839564
             );
    PEG.fly();
