 ...
 * @author jeppesen
 */
public class MarsCospar2Atmosphere extends CarbonDioxideAtmosphere {
...
5.87E-16,4.39E-16,3.34E-16,2.59E-16,2.03E-16,1.61E-16,1.30E-16};                           //300
  public MarsCospar2Atmosphere() {
    Zlimit=360000;
    gamma=1.29;
    g0=3.711;
  }

  private static Table TTable=new QuadraticTable(H,new double[][] {T,P,rho});
  private static Table PRhoTable=new LogTable(H,new double[][] {P,rho});
  public double Temp(double Alt) {
    return TTable.Interp(Alt/1000,0);
  }
  public double Pressure(double Alt) {
    return PRhoTable.Interp(Alt/1000,0);
  }
  public double MolWeight(double Alt) {
    return PRhoTable.Interp(Alt/1000,1)*1000.0*Rs*Temp(Alt)/Pressure(Alt);
  }
  public static void main(String[] args) {
    Atmosphere A=new MarsCospar2Atmosphere();
