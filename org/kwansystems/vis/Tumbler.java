...
public class Tumbler extends Applet implements ActionListener, TestFlightListener {
...
//    result.addChild(head);
  ...
  public static void main(String[] args) {
    ...
    Tumbler bb = new Tumbler();
    new MainFrame(bb, 256, 256);
    SixDOFState RVEw0=new SixDOFState(new MathVector(), new MathVector(), Quaternion.U, new MathVector(Math.toRadians(0),Math.toRadians(100),Math.toRadians(5)));
